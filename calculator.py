...
button_equ = Button(root, text = "=", padx = 87, pady = 20, command = button_equal)
button_clea = Button(root, text = "Clear", padx = 77, pady = 20, command = button_clear)

button_subtraction = Button(root, text = "-", padx = 40, pady = 20, command = button_sub)
button_multiplication = Button(root, text = "*", padx = 40, pady = 20, command = button_mul)
